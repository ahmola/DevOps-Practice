...
docker compose -p monitoring -f docker-compose-monitor.dev.yml down -v --remove-orphans

docker compose -p monitoring -f docker-compose-monitor.dev.yml up --build -d
